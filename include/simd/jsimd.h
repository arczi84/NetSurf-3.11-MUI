 ...
 * Copyright (C) 2018 Henryk Richter (addition IDCT_FLOAT_INIT)
 *
...
#ifdef IDCT_FLOAT_INIT
GLOBAL(void) jidctflt_initquant( jpeg_component_info *compptr, JQUANT_TBL *qtbl );
#endif
