...
/*
 * Some parts of the Amiga frontend still include legacy LOG() calls that
 * were never upstreamed. Provide a no-op compatibility macro so those call
 * sites build cleanly without reintroducing verbose logging output.
 */
#ifndef LOG
