...
**
** 3. Make sure the marked include line within 'gui_options_cat.h' header file uses
...
**
** 4. Include the 'gui_options_cat.h' header everywhere you need a locale string.
**
...
#include "gui_options_cat.h" /* prototypes and catcomp block */
