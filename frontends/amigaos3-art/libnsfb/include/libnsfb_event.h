...
enum nsfb_key_code_e {
    ...
    NSFB_KEY_zdot		= 191,
	NSFB_KEY_AGRAVE		= 192,	
	NSFB_KEY_AOGON_AmigaPL		= 194,
    NSFB_KEY_ADIAERESIS	= 196,
    NSFB_KEY_CACUTE		= 198,
    NSFB_KEY_CCEDIL     = 199,
	NSFB_KEY_EGRAVE		= 200,
	NSFB_KEY_EACUTE		= 201,
    NSFB_KEY_EOGON		= 202,  /* CACUTE_AmigaPL */	
    NSFB_KEY_EDIAERESIS	= 203,	/* EOGON_AmigaPL */
	NSFB_KEY_IGRAVE		= 204,
    ...
    NSFB_KEY_MOUSE_6 = 406,
    NSFB_KEY_MOUSE_7 = 407,
};
