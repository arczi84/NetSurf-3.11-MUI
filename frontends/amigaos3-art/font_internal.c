...
static nserror utf8_to_local(const char *string,
				       ...
				       char **result)
{
	return utf8_to_enc(string, "ISO-8859-2", len, result);
...
/* exported interface documented in framebuffer/freetype_font.h */
nserror
fb_font_position_internal(const plot_font_style_t *fstyle,
		 const char *string,
		 size_t length,
		 int x,
		 size_t *char_offset,
 ...
 */
nserror
fb_font_split_internal(const plot_font_style_t *fstyle,
	      const char *string,
	      size_t length,
	      int x,
	      size_t *char_offset,
...
struct gui_layout_table layout_table_internal = {
	.width = fb_font_width_internal,
	.position = fb_font_position_internal,
	.split = fb_font_split_internal,
};

struct gui_layout_table *framebuffer_layout_table_internal = &layout_table_internal;
