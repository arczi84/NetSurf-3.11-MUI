		    ...
		    void *context)
{
	...
	neww->u.scroll.btnul = fbtk_create_button(parent,
						  ...
						  scrollu.height,
						  fg,
						  load_bitmap(add_theme_path("scrollu.png")),
						  vscrollu_click,
						  neww);
	...
	neww->u.scroll.btndr = fbtk_create_button(parent,
						  ...
						  scrolld.height,
						  fg,
						  load_bitmap(add_theme_path("scrolld.png")),
						  vscrolld_click,
						  neww);
...
hscroll_redraw(fbtk_widget_t *widget, fbtk_callback_info *cbi)
{
	...
	{
		loading_timeout = 1;
		printf("Loading timeout set to 1\n");
		stop_cpu = true;
	}
	return 0;
}
		    ...
		    void *context)
{
	...
	neww->u.scroll.btnul = fbtk_create_button(parent,
						  ...
						  height,
						  fg,
						  load_bitmap(add_theme_path("scrolll.png")),
						  hscrolll_click,
						  neww);
	...
	neww->u.scroll.btndr = fbtk_create_button(parent,
						  ...
						  height,
						  fg,
						  load_bitmap(add_theme_path("scrollr.png")),
						  hscrollr_click,
						  neww);
