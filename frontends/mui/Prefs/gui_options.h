...
struct ObjApp
{
	...
	APTR	STR_Mpg_Width;
	APTR	STR_Mpg_Height;
	APTR	STR_Mpg_Bitrate;
	APTR	CY_Mpg_Audio_Rate;
	APTR	CY_Mpg_Audio_Format;
	APTR	Prebuffering;
	APTR	CH_mpg_status;
	APTR	CY_mpg_autoplay;
	APTR	PA_Mp3_player;
	...
	CONST_STRPTR	CY_Mpg_Audio_RateContent[8];
	CONST_STRPTR	CY_Mpg_Audio_FormatContent[3];
	CONST_STRPTR	CY_mpg_autoplayContent[4];
};
