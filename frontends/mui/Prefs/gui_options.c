...
struct ObjApp * CreateApp(void)
{
	...
	APTR	GR_grp_18, GR_Downloads, LA_Download_manager, obj_aux54, obj_aux55;
	APTR	LA_Download, Space_31, GR_Youtube, GR_Api_Key, LA_YouTube_url, GR_Mpg_Params;
	APTR	obj_aux56, obj_aux57, obj_aux58, obj_aux59, obj_aux60, obj_aux61;
	APTR	LA_Mpg_Audio_Rate, LA_Mpg_Audio_Format, GR_Players, LA_MP3, LA_Module;
	APTR	GR_more_mpg, obj_aux62, obj_aux63, Space_33, obj_aux64, obj_aux65, Space_32;
	APTR	LA_autoplay, LA_Mpeg, GR_Restart, obj_au, obj_aup;
	...
	object->CY_Mpg_Audio_RateContent[0] = GetMBString(MSG_CY_Mpg_Audio_Rate0);
	object->CY_Mpg_Audio_RateContent[1] = GetMBString(MSG_CY_Mpg_Audio_Rate1);
	object->CY_Mpg_Audio_RateContent[2] = GetMBString(MSG_CY_Mpg_Audio_Rate2);
	object->CY_Mpg_Audio_RateContent[3] = GetMBString(MSG_CY_Mpg_Audio_Rate3);
	object->CY_Mpg_Audio_RateContent[4] = GetMBString(MSG_CY_Mpg_Audio_Rate4);
	object->CY_Mpg_Audio_RateContent[5] = GetMBString(MSG_CY_Mpg_Audio_Rate5);
	object->CY_Mpg_Audio_RateContent[6] = GetMBString(MSG_CY_Mpg_Audio_Rate6);
	object->CY_Mpg_Audio_RateContent[7] = NULL;
	object->CY_Mpg_Audio_FormatContent[0] = GetMBString(MSG_CY_Mpg_Audio_Format0);
	object->CY_Mpg_Audio_FormatContent[1] = GetMBString(MSG_CY_Mpg_Audio_Format1);
	object->CY_Mpg_Audio_FormatContent[2] = NULL;
	object->CY_mpg_autoplayContent[0] = GetMBString(MSG_CY_mpg_autoplay0);
	object->CY_mpg_autoplayContent[1] = GetMBString(MSG_CY_mpg_autoplay1);
	//object->CY_mpg_autoplayContent[2] = GetMBString(MSG_CY_mpg_autoplay2);	
	object->CY_mpg_autoplayContent[2] = NULL;
	...
	object->CM_Autoupdate = CheckMark(TRUE);

	obj_au = Label2(GetMBString(MSG_CM_Autoupdate));

	obj_aup = GroupObject,
		MUIA_Group_Columns, 2,
		Child, obj_au,
		Child, object->CM_Autoupdate,
	End;
	...
	object->BT_select = TextObject,
		ButtonFrame,
		MUIA_Weight, 50,
		MUIA_Background, MUII_ButtonBack,
		MUIA_Text_Contents, GetMBString(MSG_BT_select),
		MUIA_Text_PreParse, "\033c",
		MUIA_HelpNode, "BT_select",
	...
	object->Listview = ListviewObject,
		...
		MUIA_Listview_List, object->FavList,
	End;
	...
	object->CH_builtin = CheckMark(FALSE);

	obj_aux55 = Label2(GetMBString(MSG_CH_builtin));

	obj_aux54 = GroupObject,
		MUIA_Group_Columns, 2,
		Child, obj_aux55,
		Child, object->CH_builtin,
	End;
	...
	object->STR_YT = StringObject,
		...
		MUIA_String_Contents, "your key here",
		MUIA_String_MaxLen, 128,
	End;

	GR_Api_Key = GroupObject,
		MUIA_HelpNode, "GR_Api_Key",
		MUIA_Group_Rows, 1,
		Child, LA_YouTube_url,
		Child, object->STR_YT,
	End;

	object->STR_Mpg_Width = StringObject,
		MUIA_Frame, MUIV_Frame_String,
		MUIA_HelpNode, "STR_Mpg_Width",
		MUIA_String_Contents, "320",
		MUIA_String_Accept, "-0123456789",
		MUIA_String_MaxLen, 4,
	End;

	obj_aux57 = Label2(GetMBString(MSG_STR_Mpg_Width));

	obj_aux56 = GroupObject,
		MUIA_Group_Columns, 2,
		MUIA_Weight, 70,
		Child, obj_aux57,
		Child, object->STR_Mpg_Width,
	End;

	object->STR_Mpg_Height = StringObject,
		MUIA_Frame, MUIV_Frame_String,
		MUIA_HelpNode, "STR_Mpg_Height",
		MUIA_String_Contents, "240",
		MUIA_String_Accept, "0123456789",
		MUIA_String_MaxLen, 4,
	End;

	obj_aux59 = Label2(GetMBString(MSG_STR_Mpg_Height));

	obj_aux58 = GroupObject,
		MUIA_Group_Columns, 2,
		MUIA_Weight, 70,
		Child, obj_aux59,
		Child, object->STR_Mpg_Height,
	End;

	object->STR_Mpg_Bitrate = StringObject,
		MUIA_Frame, MUIV_Frame_String,
		MUIA_HelpNode, "STR_Mpg_Bitrate",
		MUIA_String_Contents, "700",
		MUIA_String_Accept, "0123456789",
		MUIA_String_MaxLen, 5,
	End;

	obj_aux61 = Label2(GetMBString(MSG_STR_Mpg_Bitrate));

	obj_aux60 = GroupObject,
		MUIA_Group_Columns, 2,
		MUIA_Weight, 70,
		Child, obj_aux61,
		Child, object->STR_Mpg_Bitrate,
	End;

	LA_Mpg_Audio_Rate = Label(GetMBString(MSG_LA_Mpg_Audio_Rate));

	object->CY_Mpg_Audio_Rate = CycleObject,
		MUIA_HelpNode, "CY_Mpg_Audio_Rate",
		MUIA_Weight, 60,
		MUIA_Frame, MUIV_Frame_Button,
		MUIA_Cycle_Entries, object->CY_Mpg_Audio_RateContent,
	End;

	LA_Mpg_Audio_Format = Label(GetMBString(MSG_LA_Mpg_Audio_Format));

	object->CY_Mpg_Audio_Format = CycleObject,
		MUIA_HelpNode, "CY_Mpg_Audio_Format",
		MUIA_Weight, 60,
		MUIA_Frame, MUIV_Frame_Button,
		MUIA_Cycle_Entries, object->CY_Mpg_Audio_FormatContent,
	End;

	GR_Mpg_Params = GroupObject,
		MUIA_HelpNode, "GR_Mpg_Params",
		MUIA_Frame, MUIV_Frame_Group,
		MUIA_FrameTitle, GetMBString(MSG_GR_Mpg_ParamsTitle),
		MUIA_Group_Rows, 1,
		Child, obj_aux56,
		Child, obj_aux58,
		Child, obj_aux60,
		Child, LA_Mpg_Audio_Rate,
		Child, object->CY_Mpg_Audio_Rate,
		Child, LA_Mpg_Audio_Format,
		Child, object->CY_Mpg_Audio_Format,
	End;

	object->Prebuffering = SliderObject,
		MUIA_HelpNode, "Prebuffering",
		MUIA_Frame, MUIV_Frame_Slider,
		MUIA_Slider_Min, 0,
		MUIA_Slider_Max, 100,
	...
	obj_aux63 = Label2(GetMBString(MSG_Prebuffering));

	obj_aux62 = GroupObject,
		MUIA_Group_Columns, 2,
		Child, obj_aux63,
		Child, object->Prebuffering,
	End;

	Space_33 = HSpace(20);

	object->CH_mpg_status = CheckMark(FALSE);

	obj_aux65 = Label2(GetMBString(MSG_CH_mpg_status));

	obj_aux64 = GroupObject,
		MUIA_Group_Columns, 2,
		Child, obj_aux65,
		Child, object->CH_mpg_status,
	End;

	Space_32 = HSpace(20);

	LA_autoplay = Label(GetMBString(MSG_LA_autoplay));

	object->CY_mpg_autoplay = CycleObject,
		MUIA_HelpNode, "CY_mpg_autoplay",
		MUIA_Frame, MUIV_Frame_Button,
		MUIA_Cycle_Entries, object->CY_mpg_autoplayContent,
	End;
	
	GR_more_mpg = GroupObject,
		MUIA_HelpNode, "GR_more_mpg",
		MUIA_Group_Horiz, TRUE,
		Child, obj_aux62,
		Child, Space_33,
		Child, obj_aux64,
	...
	LA_Mpeg = Label(GetMBString(MSG_LA_Mpeg));

	object->STR_PA_Mpeg = String("", 80);

	object->PA_Mpeg = PopButton(MUII_PopDrawer);

	object->PA_Mpeg = PopaslObject,
		MUIA_HelpNode, "PA_Mpeg",
		MUIA_Popasl_Type, 0,
		MUIA_Popstring_String, object->STR_PA_Mpeg,
		MUIA_Popstring_Button, object->PA_Mpeg,
	End;
	...
	DoMethod(object->BT_select,
		MUIM_Notify, MUIA_Pressed, TRUE,
		object->WI_Preferences,
		2,
		MUIM_CallHook, &ScreenModeHook
		);
	...
	DoMethod(object->CH_bitmap_fonts,
		MUIM_Notify, MUIA_Selected, MUIV_EveryTime,
		object->WI_Preferences,
		2,
		MUIM_CallHook, &ReloadHook
	...
	DoMethod(object->WI_Preferences,
		...
		object->STR_YT,
		object->STR_Mpg_Width,
		object->STR_Mpg_Height,
		object->STR_Mpg_Bitrate,
		object->CY_Mpg_Audio_Rate,
		object->CY_Mpg_Audio_Format,
		object->Prebuffering,
		object->CH_mpg_status,
		object->CY_mpg_autoplay,
