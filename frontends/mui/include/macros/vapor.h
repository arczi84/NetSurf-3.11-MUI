 ...
 *
 *
 * $Id: vapor.h,v 1.3 2008/04/23 19:46:59 kiero Exp $
 *
*/
...
#define BEGINMTABLE2(name) \
static ULONG __saveds __asm name##_Dispatcher( \
    register struct IClass *cl __asm("a0"), \
    register Object *obj __asm("a2"), \
    register Msg msg __asm("a1")) \
{ \
...
//#define BEGINMTABLE2(name) static ULONG __asm __saveds name##_Dispatcher( __reg(a0, struct IClass *cl), __reg(a2, Object *obj), __reg(a1, Msg msg)){switch(msg->MethodID){
//#define BEGINMTABLE2(name) static ULONG name##_Dispatcher(  struct IClass *cl,  Object *obj,  Msg msg){switch(msg->MethodID){
#endif /* !__MORPHOS__ */
#else
#define BEGINMTABLE static ULONG __asm __saveds dispatch( register __a0 struct IClass *cl, register __a2  Object *obj, register __a1 Msg msg ){switch(msg->MethodID){
...
#define MUI_HOOK(n, y, z) \
	static LONG SAVEDS n##_func(struct Hook *h, y, z); \
	static struct Hook n##_hook = { 0, 0, (HOOKFUNC)HookEntry, (HOOKFUNC)n##_func }; \
	static LONG SAVEDS n##_func(struct Hook *h, y, z)
